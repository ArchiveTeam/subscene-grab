...
LUA_SHA1 = get_hash(os.path.join(CWD, 'subscene.lua'))
...
class WgetArgs(object):
    ...
    def realize(self, item):
        ...
        for item_name in item['item_name'].split('\0'):
            ...
            if item_type == 'group':
                wget_args.extend(['--warc-header', 'subscene-group-id: '+item_value])
                wget_args.append('https://subscene.com/subtitles/'+item_value)
...
project = Project(
    title=TRACKER_ID,
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://wiki.archiveteam.org/images/c/c7/Subscene-logo.gif" height="50px" title=""/>
        <h2>Subscene <span class="links"><a href="https://subscene.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/subscene/">Leaderboard</a> &middot; <a href="https://wiki.archiveteam.org/index.php/Subscene">Wiki</a></span></h2>
        <p>Archiving Subscene.</p>
    '''
)
